...
of sensor data is the only feature currently supported). Additional hardware
drivers will be developed as needed (a PWM fan driver will soon be in the works).
